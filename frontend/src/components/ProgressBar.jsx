...
const ProgressSteps = (props) => {
    ...
    return (
        <div className="relative w-145 flex justify-between m-auto mt-5">
          <div className={`absolute h-2 top-8 w-full bg-gray-300 rounded-full`}></div>
          <div className={`
            absolute h-2 top-8 max-[140px] bg-[#4A3AFF] rounded-full transition-all duration-500 ease-in-out`}
            style={{
